    ...
    <PageShell>
      ...
      <div className="grid gap-5 lg:grid-cols-[1.4fr_.6fr]">
        <article className="panel group relative overflow-hidden p-7 sm:p-9">
          <div className="absolute -right-16 -top-16 h-56 w-56 rounded-full bg-blood/25 blur-3xl transition group-hover:bg-blood/35" />
        ...
        <article className="panel grid min-h-72 place-items-center border-dashed p-8 text-center">
          <div>
            <div className="mx-auto grid h-12 w-12 place-items-center rounded-2xl border border-gold/[.12] bg-gold/[.04] text-gold"><Sparkles size={20} /></div>
